...
public class PersonEducationFunctionDataProviderUnitTest : BaseEntityDataProviderUnitTests<PersonEducationFunctionDataProvider<ThiemeMeulenhoffPlatformDbContext>, IPersonEducationFunctionValidationProvider, PersonEducationFunction>
{
    #region [ CTor ]
    public PersonEducationFunctionDataProviderUnitTest() : base(SeedProvider.Current.PersonEducationFunctions) {
    }
    #endregion

    #region [ Protected Methods - Override ]
    protected override PersonEducationFunctionDataProvider<ThiemeMeulenhoffPlatformDbContext> GetDataProvider() {
        return new PersonEducationFunctionDataProvider<ThiemeMeulenhoffPlatformDbContext>(
           this._logger.Object,
    ...
    public async Task GetByPersonAsync_Should_ThrowException_If_PersonId_IsNull() {
        // Arrange
        var entity = default(PersonEducationFunction);
