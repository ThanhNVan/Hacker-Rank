...
public class PersonEducationSubjectDataProviderUnitTest : BaseEntityDataProviderUnitTests<PersonEducationSubjectDataProvider<ThiemeMeulenhoffPlatformDbContext>, IPersonEducationSubjectValidationProvider, PersonEducationSubject>
{
    #region [ CTor ]
    public PersonEducationSubjectDataProviderUnitTest() : base(SeedProvider.Current.PersonEducationSubjects) {
    }
    #endregion

    #region [ Protected Methods - Override ]
    protected override PersonEducationSubjectDataProvider<ThiemeMeulenhoffPlatformDbContext> GetDataProvider() {
        return new PersonEducationSubjectDataProvider<ThiemeMeulenhoffPlatformDbContext>(
           this._logger.Object,
    ...
    public async Task GetByPersonAsync_Should_ThrowException_If_PersonId_IsNull() {
        // Arrange
        var entity = default(PersonEducationSubject);
