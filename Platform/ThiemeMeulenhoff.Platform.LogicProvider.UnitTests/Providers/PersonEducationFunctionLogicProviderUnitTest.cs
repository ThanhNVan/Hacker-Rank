...
public class PersonEducationFunctionLogicProviderUnitTest : BaseEntityLogicProviderUnitTest<PersonEducationFunction, IPersonEducationFunctionDataProvider, PersonEducationFunctionLogicProvider>
{
    #region [ CTor ]
    public PersonEducationFunctionLogicProviderUnitTest() {

    }
    #endregion

    #region [ Protected Methods - Override ]
    protected override PersonEducationFunctionLogicProvider OnCreateLogicProvider(IPersonEducationFunctionDataProvider dataProvider, ILogger<PersonEducationFunctionLogicProvider> logger) {
        return new PersonEducationFunctionLogicProvider(logger, dataProvider);
    }
    #endregion
