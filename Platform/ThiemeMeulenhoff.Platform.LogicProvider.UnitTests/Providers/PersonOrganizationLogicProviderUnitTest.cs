...
public class PersonOrganizationLogicProviderUnitTest : BaseEntityLogicProviderUnitTest<PersonOrganization, IPersonOrganizationDataProvider, PersonOrganizationLogicProvider>
{
    #region [ CTor ]
    public PersonOrganizationLogicProviderUnitTest() {

    }
    #endregion

    #region [ Protected Methods - Override ]
    protected override PersonOrganizationLogicProvider OnCreateLogicProvider(IPersonOrganizationDataProvider dataProvider, ILogger<PersonOrganizationLogicProvider> logger) {
        return new PersonOrganizationLogicProvider(logger, dataProvider);
    }
    #endregion
