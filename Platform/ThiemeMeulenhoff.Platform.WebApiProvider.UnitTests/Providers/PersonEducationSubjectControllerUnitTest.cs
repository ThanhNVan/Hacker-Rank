...
//public class PersonEducationSubjectControllerUnitTest : BaseControllerUnitTest<PersonEducationSubject, IPersonEducationSubjectLogicProvider, PersonEducationSubjectController>
//{
//    #region [ CTor ]
//    public PersonEducationSubjectControllerUnitTest() {

//    }
//    #endregion

//    #region [ Protected Methods - Override ]
//    protected override PersonEducationSubjectController OnGetController(ILogger<PersonEducationSubjectController> logger, IPersonEducationSubjectLogicProvider logic) {
//        return new PersonEducationSubjectController(logger, logic);
//    }
//    #endregion
...
//        var entity = this._fixture.Create<PersonEducationSubject>();
...
//        var personId = this._fixture.Create<string>();
//        var organizationId = this._fixture.Create<string>();
//        this._logic.Setup(x => x.GetByPersonAndOrganisationAsync(personId, organizationId)).ReturnsAsync(default(PersonEducationSubject));
//        // Act
//        var actual = await this._controller.GetByPersonAndOrganisationAsync(personId, organizationId);
...
//        // Arrange
//        var personId = this._fixture.Create<string>();
//        var entity = this._fixture.Create<List<PersonEducationSubject>>();
...
//        // Arrange
//        var personId = this._fixture.Create<string>();
//        this._logic.Setup(x => x.GetByPersonAsync(personId)).ReturnsAsync(default(List<PersonEducationSubject>));
//        // Act
//        var actual = await this._controller.GetByPersonAsync(personId);
...
//        // Arrange
//        var organizationId = this._fixture.Create<string>();
//        this._logic.Setup(x => x.GetByOrganizationAsync(organizationId)).ReturnsAsync(default(List<PersonEducationSubject>));
//        // Act
//        var actual = await this._controller.GetByOrganizationAsync(organizationId);
