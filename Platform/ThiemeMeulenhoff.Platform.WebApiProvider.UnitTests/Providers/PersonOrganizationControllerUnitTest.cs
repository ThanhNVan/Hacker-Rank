...
//public class PersonOrganizationControllerUnitTest : BaseControllerUnitTest<PersonOrganization, IPersonOrganizationLogicProvider, PersonOrganizationController>
//{
//    #region [ CTor ]
//    public PersonOrganizationControllerUnitTest() {

//    }
//    #endregion

//    #region [ Protected Methods - Override ]
//    protected override PersonOrganizationController OnGetController(ILogger<PersonOrganizationController> logger, IPersonOrganizationLogicProvider logic) {
//        return new PersonOrganizationController(logger, logic);
//    }
//    #endregion
...
//        var entity = this._fixture.Create<PersonOrganization>();
...
//        var personId = this._fixture.Create<string>();
//        var organizationId = this._fixture.Create<string>();
//        this._logic.Setup(x => x.GetByPersonAndOrganisationAsync(personId, organizationId)).ReturnsAsync(default(PersonOrganization));
//        // Act
//        var actual = await this._controller.GetByPersonAndOrganisationAsync(personId, organizationId);
...
//        // Arrange
//        var personId = this._fixture.Create<string>();
//        var entity = this._fixture.Create<List<PersonOrganization>>();
...
//        // Arrange
//        var personId = this._fixture.Create<string>();
//        this._logic.Setup(x => x.GetByPersonAsync(personId)).ReturnsAsync(default(List<PersonOrganization>));
//        // Act
//        var actual = await this._controller.GetByPersonAsync(personId);
...
//        // Arrange
//        var organizationId = this._fixture.Create<string>();
//        this._logic.Setup(x => x.GetByOrganizationAsync(organizationId)).ReturnsAsync(default(List<PersonOrganization>));
//        // Act
//        var actual = await this._controller.GetByOrganizationAsync(organizationId);
